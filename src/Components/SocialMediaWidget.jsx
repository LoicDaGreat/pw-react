const SocialMediaWidget = () => {
  return (
    <div className="absolute right-8 top-1/2 transform -translate-y-1/2 flex flex-col space-y-6">
        ...
        <a href="#" className="text-white hover:text-blue-500 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-twitter-icon lucide-twitter">
        ...
        <div className="w-px h-16 bg-white opacity-30 mx-auto mt-8"></div>
    </div>
  )
}
